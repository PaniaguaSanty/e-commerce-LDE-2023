 ...
 * @author sjcex
 */
public final class Management_Warehouses_Panel extends javax.swing.JPanel implements InterfaceCrudPanel {
    ...
    private void initComponents() {
        ...
        jPanel_crudLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_crudLayout.createSequentialGroup()
                ...
                .addGap(77, 77, 77)
                .addGroup(jPanel_crudLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jtf_address, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
                    .addComponent(jtf_code, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jbl_filter.setText("Filtrar por code:");
        ...
        jScrollPaneTabla1.setViewportView(tableSectors);
                ...
                .addGroup(jPanel_datos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel_datos1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel_datos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel_datos1Layout.createSequentialGroup()
                                .addComponent(jScrollPaneTabla1, javax.swing.GroupLayout.PREFERRED_SIZE, 573, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jlbl_info, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jScrollPaneTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 573, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel_datos1Layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel_datos1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel_datos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel_datos1Layout.createSequentialGroup()
                                ...
                                .addGap(77, 77, 77)
                                .addGroup(jPanel_datos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jtf_latitude, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jtf_longitude, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel_datos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel_datos1Layout.createSequentialGroup()
                                        .addGap(62, 62, 62)
                                    ...
                                    .addGroup(jPanel_datos1Layout.createSequentialGroup()
                                        .addGap(74, 74, 74)
                                        .addComponent(jbn_delete, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
        ...
        jPanel_datos1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel_datos1Layout.createSequentialGroup()
                ...
                .addGap(15, 15, 15)
                .addComponent(jScrollPaneTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(jPanel_datos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_datos1Layout.createSequentialGroup()
                        .addGap(65, 65, 65)
                    ...
                    .addGroup(jPanel_datos1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jScrollPaneTabla1, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public void initListener() {
        ...
        tableWarehouse.getSelectionModel().addListSelectionListener(new DefaultTableListener(this));
    }
    ...
    private void loadSector(Warehouse warehouse) {
        DefaultTableModel model = new DefaultTableModel();
        String[] titles = {"Nombre", "Pedidos"};
        model.setColumnIdentifiers(titles);
        List<Sector> sectors = sectorService.findAll();
        for (Sector sec : sectors) {
            if (sec.getWarehouse().getCode().equals(warehouse.getCode())) {
                Object[] object = {sec.getName(), sec.getOrders()};
                model.addRow(object);
                
            }
        }
        tableSectors.setModel(model);
    }
